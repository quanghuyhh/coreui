...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('work_times', function (Blueprint $table) {
            ...
            $table->tinyInteger('shift_start_time')->nullable();
            $table->tinyInteger('shift_end_time')->nullable();
            $table->tinyInteger('shift_break_time')->nullable();
            $table->boolean('use_off_shift')->default(false);
            $table->tinyInteger('off_shift_qa_time')->nullable();
            $table->tinyInteger('off_shift_training_time')->nullable();
            $table->tinyInteger('off_shift_absent_time')->nullable();
            $table->tinyInteger('off_shift_additional_time')->nullable();
            ...
            $table->tinyInteger('night_time')->nullable()->comment('10:30 → 1030');
            $table->boolean('training_type')->default(false)->nullable()->comment('"type of 特訓時間: 0: 本日の特訓はなし, 1 : 時間数を入れる"');
            $table->tinyInteger('training_time')->nullable()->comment('10:30 → 1030');
